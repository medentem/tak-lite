...
import com.tak.lite.ui.map.PoiTimerManager.TimerFeature
import org.maplibre.android.maps.Projection

/**
 * Custom overlay view for rendering timer countdown text
 */
class TimerTextOverlayView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : View(context, attrs, defStyleAttr), PoiTimerManager.TimerTextOverlayCallback {

    companion object {
        private const val TAG = "TimerTextOverlayView"
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (timerFeature in timerFeatures) {
            try {
                ...
                // Draw countdown text below the POI
                ...
                Log.e(TAG, "Error drawing timer text for ${timerFeature.poiId}", e)
            }
        }
    }
    ...
    private fun drawCountdownText(canvas: Canvas, center: PointF, text: String) {
        ...
        val rectTop = center.y + 50f // Position below the POI
